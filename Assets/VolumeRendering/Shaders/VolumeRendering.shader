Shader "VolumeRendering/VolumeRendering"
{
	Properties
	{
		...
		_FirstSegmentColor("FirstSegmentColor", Color) = (0, 1, 0, 0)
		_SecondSegmentColor("SecondSegmentColor", Color) = ( 0, 0, 1, 0 )
		_ThirdSegmentColor("ThirdSegmentColor", Color) = ( 1, 0, 0, 0 )
